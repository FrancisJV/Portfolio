...
export function Expertise() {
  return (<section id="expertise" className="pt-8 pb-20 md:pt-10 md:pb-28 bg-dark-900/60 relative border-t border-dark-800/80">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-1.5">
                  {category.skills.map((skill) => (
                    <span
                      key={skill}
                      className="px-3 py-1.5 rounded-lg bg-dark-950/70 border border-dark-750 text-[12px] font-medium text-slate-300 group-hover:border-dark-700 hover:text-white transition-colors"
                    >
                      {skill}
                    </span>
                  ))}
