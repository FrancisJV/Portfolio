...
export function Footer() {
  ...
  const hasLinkedin = Boolean(
    ...
    socialLinks.linkedin.url.trim() !== ''
  );

  const hasGithub = Boolean(
    socialLinks.github &&
    socialLinks.github.url &&
    socialLinks.github.url.trim() !== ''
  );

  return (
    <footer className="bg-dark-950 border-t border-dark-800/80 pt-6 pb-6 relative">
      <Container>
          ...
          <div className="flex flex-col items-center md:items-end">
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                type="button"
                onClick={scrollToTop}
                className="p-2.5 rounded-xl bg-dark-900 border border-dark-750 text-slate-300 hover:text-brand-300 hover:border-brand-500/40 transition-colors"
